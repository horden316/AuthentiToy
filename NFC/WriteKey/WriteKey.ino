...
void loop() {
  ...
  writeBlock(sector, block, blockData0);  // 區段編號、區塊編號、包含寫入資料的陣列
  writeBlock(sector, block2, blockData1);  // 區段編號、區塊編號、包含寫入資料的陣列
  writeBlock(sector2, block, blockData2);  // 區段編號、區塊編號、包含寫入資料的陣列
  writeBlock(sector2, block2, blockData3);  // 區段編號、區塊編號、包含寫入資料的陣列
